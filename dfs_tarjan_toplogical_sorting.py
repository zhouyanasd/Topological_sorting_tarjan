...
if __name__ == '__main__':
    ...
    topological_sorting_tarjan = Topological_sorting_tarjan(g)
    topological_sorting_tarjan.dfs()

    print(topological_sorting_tarjan.suggest_inout())
    print('--')
    print(topological_sorting_tarjan._sorting)
    print('--')
    print(topological_sorting_tarjan.components)